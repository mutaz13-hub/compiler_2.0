...
public class CSSLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"WS", "COMMENT", "LBRACE", "RBRACE", "COLON", "SEMI", "COMMA", "LPAREN", 
			"RPAREN", "GT", "PLUS", "TILDE", "STAR", "DOT", "HASH", "PERCENT", "AMP", 
			"BANG", "ATKEYWORD", "STRING", "NUMBER", "HEXCOLOR", "UNIT", "URL", "IDENT", 
			"NAMESTART", "NAMECHAR", "DIGIT", "HEXDIGIT", "CLASS_SELECTOR", "ID_SELECTOR", 
			"PSEUDO", "ATTR_OPEN", "ATTR_CLOSE", "EQUALS", "ANY_CHAR"
		};
	}
